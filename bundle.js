...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cssStylesSass = __webpack_require__(196);

	var _cssStylesSass2 = _interopRequireDefault(_cssStylesSass);

	var _componentsAppReact = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "NOWTVText_W_Rg.woff2"
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _apiApi2['default'].getCategories(function (data) {
	        _this.setState({
	          loading: false,
	          categories: data
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NowHeader = (function (_React$Component) {
	  _inherits(NowHeader, _React$Component);

	  function NowHeader() {
	    _classCallCheck(this, NowHeader);

	    _get(Object.getPrototypeOf(NowHeader.prototype), "constructor", this).apply(this, arguments);
	  }

	  _createClass(NowHeader, [{
	    key: "render",
	    value: function render() {
	      return _react2["default"].createElement(
	        "header",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesFavoritesStore = __webpack_require__(208);

	var _storesFavoritesStore2 = _interopRequireDefault(_storesFavoritesStore);

	var _actionsFavoriteActions = __webpack_require__(222);

	var _actionsFavoriteActions2 = _interopRequireDefault(_actionsFavoriteActions);
	...
	var Movie = (function (_React$Component) {
	  ...
	  _createClass(Movie, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _storesFavoritesStore2['default'].listen(this.onChange);
	      this.setState(_storesFavoritesStore2['default'].getState());
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'like', onClick: this.likeMovie },
	          this.state.liked ? _react2['default'].createElement('i', { className: 'fa fa-heart' }) : _react2['default'].createElement('i', { className: 'fa fa-heart-o' })
	        ),
	        _react2['default'].createElement(
	          'div',
	          { className: 'container' },
	    ...
	    key: 'likeMovie',
	    value: function likeMovie() {
	      _actionsFavoriteActions2['default'].likeMovie();
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FavoriteActions = (function () {
	  function FavoriteActions() {
	    _classCallCheck(this, FavoriteActions);
	  }

	  _createClass(FavoriteActions, [{
	    key: 'likeMovie',
	    value: function likeMovie(res) {
	      this.dispatch(res);
	    }
	  }]);
